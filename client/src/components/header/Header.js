...
export default function Header({products}) {
    return (
        <div className="bg-dark" style={{position: 'fixed',zIndex:99,width:'100%'}}>
            <div className="topBar">
                <Container className="d-flex justify-content-between align-items-center w-100">
                    <div className="d-flex align-items-center">
                    <img src="https://res.cloudinary.com/dtmlbvagx/image/upload/v1651896217/design/LOGO_WEB-01_ky1xii.png" alt="Logo Design Market" height="20"/>
